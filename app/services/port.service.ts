...
export class PortService {
  private countries: Country[] = [
    new Country({
      ...
      name: 'Japan',
      flag: 'jp',
      ports: [new Port({ id: 0, name: 'Tokai' })],
    }),
    new Country({
      id: 2,
      name: 'Russia',
      flag: 'ru',
      ports: [new Port({ id: 2, name: 'Vladivostok' })],
    }),
    new Country({
      id: 3,
      name: 'India',
      flag: 'in',
      ports: [new Port({ id: 3, name: 'Navlakhi' })],
    }),
    new Country({
      id: 4,
      name: 'Cayman Islands',
      flag: 'ky',
      ports: [new Port({ id: 4, name: 'Cayman Brac' })],
    }),
    new Country({
      id: 6,
      name: 'Egypt',
      flag: 'eg',
      ports: [new Port({ id: 6, name: 'Port Ibrahim' })],
    }),
    new Country({
      id: 7,
      name: 'Finland',
    ...
    new Country({
      ...
      name: 'Germany',
      flag: 'ge',
      ports: [new Port({ id: 8, name: 'Brake' })],
    }),
    new Country({
      id: 9,
      name: 'Canada',
      flag: 'ca',
      ports: [new Port({ id: 9, name: 'Hantsport NS' })],
    }),
    new Country({
      id: 11,
      name: 'Chile',
    ...
    new Country({
      ...
      name: 'Curacao',
      flag: 'cw',
      ports: [new Port({ id: 17, name: 'Santa Anna Bay' })],
    }),
    new Country({
      id: 14,
      name: 'Sri Lanka',
      flag: 'lk',
      ports: [new Port({ id: 18, name: 'Hambantota' })],
    }),
    new Country({
      id: 15,
      name: 'Madagascar',
      flag: 'mg',
      ports: [new Port({ id: 19, name: 'Antananarivo' })],
    }),
    new Country({
      id: 5,
      name: 'Brazil',
    ...
    new Country({
      ...
      name: 'Ireland',
      flag: 'ie',
      ports: [new Port({ id: 21, name: 'Bantry Bay' })],
    }),
    new Country({
      id: 17,
      name: 'Italy',
      flag: 'it',
      ports: [new Port({ id: 22, name: 'Porto Levante' })],
    }),
    new Country({
      id: 18,
      name: 'Greece',
      flag: 'gr',
      ports: [new Port({ id: 23, name: 'Port of Antikyra' })],
    }),
    new Country({
      id: 19,
      name: 'Malaysia',
    ...
    new Country({
      ...
      name: 'Panama',
      flag: 'pa',
      ports: [new Port({ id: 26, name: 'Almirante' })],
    }),
    new Country({
      id: 22,
      name: 'China',
    ...
    new Country({
      ...
      name: 'Somalia',
      flag: 'so',
      ports: [new Port({ id: 28, name: 'Dante' })],
    }),
    new Country({
      id: 24,
      name: 'United States',
      flag: 'us',
      ports: [new Port({ id: 29, name: 'Davant LA' })],
    }),
    new Country({
      id: 25,
      name: 'Australia',
      flag: 'au',
      ports: [new Port({ id: 30, name: 'Fremantle' })],
    }),
    new Country({
      id: 26,
      name: 'Philippines',
      flag: 'ph',
      ports: [new Port({ id: 31, name: 'General Santos' })],
    }),
    new Country({
      id: 27,
      name: 'United Kingdom',
      flag: 'gb',
      ports: [new Port({ id: 32, name: 'Granton' })],
    }),
    new Country({
      id: 28,
      name: 'Venezuela',
      flag: 've',
      ports: [new Port({ id: 33, name: 'Guanta' })],
    }),
    new Country({
      id: 29,
      name: 'Indonesia',
      flag: 'id',
      ports: [new Port({ id: 35, name: 'Kalimantan' })],
    }),
    new Country({
      id: 30,
      name: 'Thailand',
      flag: 'th',
      ports: [new Port({ id: 36, name: 'Kantang' })],
    }),
    new Country({
      id: 31,
      name: 'Ecuador',
      flag: 'ec',
      ports: [new Port({ id: 40, name: 'Manta' })],
    }),
    new Country({
      id: 32,
      name: 'France',
      flag: 'fr',
      ports: [new Port({ id: 41, name: 'Mantes' })],
    }),
  ];
